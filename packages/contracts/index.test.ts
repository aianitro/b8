...
// `./types.ts`, not `../types.ts`: P1-10a moved `shared/types.ts` into this package, because a
// shared contracts package that imports its own domain types from the web app has its
// dependency arrow pointing the wrong way — the phone could not use it.
