...
export default function CategoryDonutChart({ data }: { data: CategorySlice[] }) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
      ...
      {/* A side with no rows is omitted rather than drawn empty. The dashboard is scoped to the
          operational book, so a permanent "Capital: no data" panel beside the operational donut
          reads as a broken query rather than as a deliberate scope. */}
