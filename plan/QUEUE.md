...
| P0.5-31-dashboard-repoint | Phase 0.5, step 31 ([ITEM.md](tasks/P0.5-31-dashboard-repoint/ITEM.md)) | **MERGED** 2026-09-02 (G0 ✅ G1 SKIP G2 ✅ G3 ✅ G4 ✅, 0 cycles). **Two owner handoffs outstanding: screenshot capture (A1), and a `control_mode` write path (N51) without which the new hero reads "Nothing to score yet" on real data** | P0.5-29a (merged), P0.5-30 (merged) | expected none — G1 skips unless the spec finds otherwise |
...
| P0.5-33-delivery-channel | Phase 0.5, step 33 ([ITEM.md](tasks/P0.5-33-delivery-channel/ITEM.md)) | **G4 PASS** 2026-09-04 (G0 ✅ G1 ✅ G2 ✅ G3 ✅ G4 ✅, 1 cycle) — **awaiting merge commit**. Owner handoff: the SMTP credential, and the first send | P0.5-32 (merged) | `migrations/**`, `db/schema.sql` — new `alert_sends` table, additive; lease opened and closed |
