...
| P0.5-28-category-control-mode | Phase 0.5, step 28 ([ITEM.md](tasks/P0.5-28-category-control-mode/ITEM.md)) | **IMPL** (G0 ✅ 3 drafts, G1 ✅) | — | `shared/types.ts`, `migrations/**`, `db/schema.sql` |
